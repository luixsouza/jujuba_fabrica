...
const FornecedoresPage = () => {
  ...
  const filteredFornecedores = useMemo(() => {
    ...
    return fornecedores.filter((fornecedora) => {
      ...
      const contato = fornecedora.contato
        ? fornecedora.contato.toLowerCase()
        : "";
      const endereco = fornecedora.endereco
        ? fornecedora.endereco.toLowerCase()
        : "";
      const chavePix = fornecedora.chavePix
        ? fornecedora.chavePix.toLowerCase()
        : "";
      const credito =
        fornecedora.creditoLoja || fornecedora.valorCredito || ""
          ? String(
              fornecedora.creditoLoja ?? fornecedora.valorCredito
            ).toLowerCase()
          : "";
                    ...
                    .map((fornecedora) => (
                      <TableRow key={fornecedora.id}>
                        ...
                        >
                          ...
                          <IconButton
                            onClick={() => handleDeleteClick(fornecedora)}
                            sx={{ color: "#d32f2f" }}
                          >
                            <DeleteIcon />
                          </IconButton>
